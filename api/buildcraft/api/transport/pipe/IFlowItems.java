...
public interface IFlowItems extends IInjectable {
    ...
    @Deprecated
    default int tryExtractItems(int count, FaceInfo from, @Nullable DyeColor colour, IStackFilter filter) {
    ...
    int tryExtractItems(int count, FaceInfo from, @Nullable DyeColor colour, IStackFilter filter, boolean simulate);
     ...
     *            used. */
    void insertItemsForce(@Nonnull ItemStack stack, FaceInfo from, @Nullable DyeColor colour, double speed);
    ...
    void sendPhantomItem(@Nonnull ItemStack stack, @Nullable FaceInfo from, @Nullable FaceInfo to, @Nullable DyeColor colour);
}
