...
public final class PluggableDefinition {
    ...
    public PipePluggable readFromNbt(IPipeHolder holder, FaceInfo side, CompoundTag nbt) {
        return reader.readFromNbt(this, holder, side, nbt);
    }

    public PipePluggable loadFromBuffer(IPipeHolder holder, FaceInfo side, FriendlyByteBuf buffer)
    ...
    public interface IPluggableNbtReader {
        ...
        PipePluggable readFromNbt(PluggableDefinition definition, IPipeHolder holder, FaceInfo side,
            CompoundTag nbt);
    }

    @FunctionalInterface
    public interface IPluggableNetLoader {
        PipePluggable loadFromBuffer(PluggableDefinition definition, IPipeHolder holder, FaceInfo side,
    ...
    public interface IPluggableCreator extends IPluggableNbtReader, IPluggableNetLoader {
        @Override
        default PipePluggable loadFromBuffer(PluggableDefinition definition, IPipeHolder holder, FaceInfo side,
                                             FriendlyByteBuf buffer) {
            return createSimplePluggable(definition, holder, side);
        }

        @Override
        default PipePluggable readFromNbt(PluggableDefinition definition, IPipeHolder holder, FaceInfo side,
            CompoundTag nbt) {
            return createSimplePluggable(definition, holder, side);
        }

        PipePluggable createSimplePluggable(PluggableDefinition definition, IPipeHolder holder, FaceInfo side);
    }
}
