...
public interface IStripesHandlerItem {
     ...
     * {@link IStripesActivator#sendItem(ItemStack, FaceInfo)}
     * 
     * @param world
     * @param pos
     * @param direction
    ...
    boolean handle(Level world, BlockPos pos, FaceInfo direction, ItemStack stack, Player player, IStripesActivator activator);
}
