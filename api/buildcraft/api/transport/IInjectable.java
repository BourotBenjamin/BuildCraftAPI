...
public interface IInjectable {
     ...
     * call {@link #injectItem(ItemStack, boolean, FaceInfo, DyeColor, double)} straight after. */
    boolean canInjectItems(FaceInfo from);
    ...
    @Nonnull
    ItemStack injectItem(@Nonnull ItemStack stack, boolean doAdd, FaceInfo from, DyeColor color, double speed);
}
