...
public class BCDebugging {
    ...
    static {
        ...
        boolean isDev;
        try {
            Method getTileEntity = Level.class.getDeclaredMethod("getBlockEntity", BlockPos.class);
            BCLog.logger.info("[debugger] Method found: World.getBlockEntity = " + getTileEntity);
            isDev = true;
