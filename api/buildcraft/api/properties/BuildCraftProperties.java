...
public final class BuildCraftProperties {
   /* TODO : Fix
    public static final Property<FaceInfo> BLOCK_FACING = EnumProperty.create("facing", FaceInfo.class, FaceInfo.Plane.HORIZONTAL.facings());
    public static final Property<FaceInfo> BLOCK_FACING_6 = EnumProperty.create("facing", FaceInfo.class);
    */
    ...
    public static final Map<FaceInfo, Property<Boolean>> CONNECTED_MAP;
    ...
    static {
        Map<FaceInfo, Property<Boolean>> map = Maps.newEnumMap(FaceInfo.class);
        map.put(FaceInfo.DOWN, CONNECTED_DOWN);
        map.put(FaceInfo.UP, CONNECTED_UP);
        map.put(FaceInfo.EAST, CONNECTED_EAST);
        map.put(FaceInfo.WEST, CONNECTED_WEST);
        map.put(FaceInfo.NORTH, CONNECTED_NORTH);
        map.put(FaceInfo.SOUTH, CONNECTED_SOUTH);
